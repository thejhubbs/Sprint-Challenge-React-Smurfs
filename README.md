...
In client side routing, the server sends a package which is downloaded by the browser, and the routing is handled by the browswer. In server side, the server preprocesses (most) things and sends a fresh page with every url change.

- [ ] What does HTTP stand for?
HyperText transfer protocol, the way/format that information is passed online

- [ ] What does CRUD stand for?
Create, Read, Update, Delete, the 4 main ways to interact with data
